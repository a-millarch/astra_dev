...
| **Sedation and NMB** | 0--5 | 0 | No sedation | -- | PADIS [10], RASS [11] |
| | | 1 | Ward-level | Melatonin, zopiclone, oxazepam | |
| | | 2 | ICU light / delirium Rx | Dexmedetomidine, clonidine, haloperidol, olanzapine, quetiapine | |
| | | 3 | ICU deep sedation | Propofol infusion, midazolam, lorazepam | |
| | | 4 | Deep sedation + NMBA bolus | Tier 3 + suxamethonium or single rocuronium | |
| | | 5 | Deep sedation + NMBA infusion | Tier 3 + cisatracurium or continuous rocuronium | |
...
| **Surgical exposure** | 0--3 | 0 | No surgical markers | -- | -- |
| | | 1 | Regional anesthesia | Any local anesthetic (N01BB) | |
| | | 2 | General anesthesia | Esketamine, propofol bolus, volatile agent, or opioid + propofol | |
...
Abbreviations: ASI, Antibiotic Spectrum Index; AWaRe, Access Watch Reserve; CV, cardiovascular; DOAC, direct oral anticoagulant; ICP, intracranial pressure; LMWH, low-molecular-weight heparin; NED, norepinephrine-equivalent dose; NMB, neuromuscular blockade; NMBA, neuromuscular blocking agent; OR, operating room; PCC, prothrombin complex concentrate; RASS, Richmond Agitation-Sedation Scale; rFVIIa, recombinant activated factor VII; RSI, rapid sequence induction; SC, subcutaneous; SOFA-CV, Sequential Organ Failure Assessment cardiovascular component; TPN, total parenteral nutrition; TXA, tranexamic acid; VKA, vitamin K antagonist.
...
Sedation intensity was encoded as a six-level ordinal feature (0-5) integrating sedative agent class, neuromuscular blocking agent (NMBA) use, and delirium pharmacotherapy. The tier structure was informed by the Pain, Agitation/sedation, Delirium, Immobility, and Sleep disruption (PADIS) clinical practice guidelines [10], which conditionally recommend light sedation (Richmond Agitation-Sedation Scale [RASS] -2 to +1) [11] and evidence that early deep sedation is independently associated with increased mortality [12,13].

Tier 0 indicated no sedation. Tier 1 comprised ward-level sleep aids and anxiolytics (melatonin, zopiclone, oxazepam). Tier 2 included ICU light sedation agents (dexmedetomidine, clonidine) and antipsychotics for delirium management (haloperidol, olanzapine, quetiapine). Tier 3 indicated deep sedation with propofol infusion, midazolam, or lorazepam. Tier 4 indicated deep sedation with concurrent NMBA bolus (suxamethonium or single rocuronium dose, typically for intubation). Tier 5 indicated deep sedation with continuous NMBA infusion (cisatracurium or sustained rocuronium), reflecting the most severe clinical scenarios such as refractory hypoxemia or intracranial pressure crisis [14,15].

Propofol (ATC N01AX10), classified under general anesthetics rather than sedatives in the ATC system, was assigned to sedation or anesthesia context based on administration pattern: infusion-type dose units indicated ICU sedation, while single bolus administrations indicated perioperative anesthesia. Centrally acting muscle relaxants (chlorzoxazone, baclofen; ATC M03B) were excluded as they carry no ICU severity signal, in contrast to peripheral NMBAs (ATC M03A) which are ICU-specific agents.
...
### Surgical Exposure (1 feature)

Surgical and procedural exposure was encoded as a four-level ordinal feature (0-3). Tier 0 indicated no surgical markers. Tier 1 indicated regional anesthesia alone (any local anesthetic ATC N01BB), suggesting a nerve block or epidural for pain management. Tier 2 indicated general anesthesia or major procedure, identified by esketamine administration (the predominant induction agent for hemodynamically unstable patients in Danish practice), propofol bolus, volatile anesthetic exposure, or co-administration of an opioid anesthetic agent with propofol. Tier 3 indicated emergency or neurosurgical procedure, marked by thiopental administration, which in contemporary practice is reserved almost exclusively for refractory intracranial pressure management or emergency rapid sequence induction [23].

Esketamine (ATC N01AX14) was the Danish-specific agent of note, as etomidate use was negligible in the cohort. Propofol administrations classified as anesthesia (bolus context) contributed to the surgical tier but not to the sedation tier, and vice versa for propofol infusions, preventing double-counting of the same drug across features.
...
For each patient and temporal bin, the maximum tier was taken across all medication administrations within that bin for each ordinal feature. This max-aggregation approach captures escalation intensity and naturally handles both concurrent and sequential administration within a bin. The count-based features (antibiotic polypharmacy, comorbidity medication count, treatment dimensionality) used sum or count aggregation as appropriate.
